...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Variáveis alteradas para gerar a free camera
        glm::vec4 camera_position_c  = glm::vec4(fixed_x,fixed_y,fixed_z,1.0f) + camera_movement;
        glm::vec4 camera_view_vector = glm::vec4(-x,-y,-z,0.0f); // Vetor "view", sentido para onde a câmera está virada

        // Cálculo dos vetores w e u utilizados para a movimentação da câmera
