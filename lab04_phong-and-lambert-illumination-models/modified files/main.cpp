...
int main(int argc, char* argv[])
{
    ...
    GLFWwindow* window;
    window = glfwCreateWindow(800, 600, "INF01047 - 00228729 - Matheus Henrique Sabadin", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Desenho do plano do chão, com translação de -1 na direção do eixo Y, e escalado 2 vezes na direção dos eixos X e Z
